...
const CancelRemoveButton: FC<IProps> = ({ className, onClick, style }) => {
  return (
    <div
      className={className ? `${styles['cancel-btn-wrapper']} ${className}` : styles['cancel-btn-wrapper']}
      style={style}
    >
      <button onClick={onClick}>
        <div className={styles['cancel-btn-timer']}>
          <div className={styles['cancel-btn-timer__line']}></div>
          <div className={styles['cancel-btn-timer__body']}>
            <div className={styles['cancel-btn-timer__counter']}>
              <span>5</span>
              <span>4</span>
              <span>3</span>
              <span>2</span>
        ...
        <p className={styles['cancel-btn-text']}>UNDO</p>
...
export default CancelRemoveButton;
